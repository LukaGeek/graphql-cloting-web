...
export default function AdminAddProductForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name || !image1) {
      setToastMessage("Name and image1 are required.");
      setToastType("error");
      return;
    }
    ...
    try {
      ...
      if (data.addProduct) {
        setToastMessage("Product has been successfully added!");
    ...
    <div className="mt-10 max-w-md mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex space-x-2">
          <button
            type="submit"
            className="w-[25rem] bg-indigo-600 text-white text-sm font-medium py-2 rounded-md shadow hover:bg-indigo-700 focus:outline-none"
          >
            Update Product
          </button>
          <button
            type="button"
            className="w-[4rem] bg-indigo-600 text-white text-sm font-medium py-2 rounded-md shadow hover:bg-indigo-700 focus:outline-none"
          >
